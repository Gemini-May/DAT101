"use strict";
import lib2d from "../../common/script/libs/lib2d.mjs";
import libSound from "../../common/script/libs/libsound.mjs";
...
export const GameProps = {
  ...
  score: 0,
  bestScore: 0,
  sounds: {countDown: null, food: null, gameOver: null, dead: null, running: null, wingflap: null},
};
...
function loadGame() {
  ...
  GameProps.sounds.wingflap = new libSound.TSoundFile("./Media/wingflap.mp3");
...
function setSoundOnOff() {
  console.log("Checkbox state:", chkMuteSound.checked);
...
function onKeyDown(aEvent) {
  switch (aEvent.code) {
    case "Space":
      if (!GameProps.hero.isDead) {
        GameProps.hero.flap();
        GameProps.sounds.wingflap.stop();
        GameProps.sounds.wingflap.play();
      }
      break;
  }
}
